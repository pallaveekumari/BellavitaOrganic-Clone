  ...
  return (
    <div>
          ...
          <Box className={style.bottom}>
                  {/* <Box>
                    <Box className={style.botbox}> 
                      <img className={style.botimg} src="https://cdn.shopify.com/s/files/1/0054/6665/2718/files/payments-stripe-footer_256x256_e_400x.png?v=1650369513" alt="" />
                    </Box>
                    <Box> 
                      <img className={style.botimg} src="https://cdn.shopify.com/s/files/1/0054/6665/2718/files/payments-stripe-footer_256x256_e_400x.png?v=1650369513" alt="" />
                    </Box>
