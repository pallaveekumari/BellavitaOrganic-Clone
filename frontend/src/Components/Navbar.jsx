...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      >
        <Heading style={{ fontSize: "15px", marginTop: "10px" }}>
          Flexi Box - Buy any 4 products RS499
        </Heading>
        <button
          style={{
            background: "#475D4B",
              ...
              <ModalContent>
                ...
                <ModalBody>
                  ...
                  {cartdata.length > 0 ? (
                    ...
                    <Box>
                      <h1>
                        Your Cart Is Empty! Please Add Products For Shopping
                      </h1>
                    </Box>
                  )}
                </ModalBody>
      ...
      >
        <Box style={{ height: "100%", width: "80%", margin: "auto" }}>
          ...
          >
            ...
            <Link to="/product">
              <Box className={style.build}>NEW ARRIVALS</Box>
            </Link>
            ...
            <Menu isLazy>
              ...
              <MenuList>
                ...
                <img
                  className={style.img}
                  src="https://cdn.shopify.com/s/files/1/0054/6665/2718/products/C-GlowFaceSerum-01_1_765x.jpg?v=1651698248"
                  alt=""
                />
              </MenuList>
            </Menu>
